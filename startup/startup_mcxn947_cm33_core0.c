...
__attribute__((used, section(".isr_vector"))) void (*const g_pfnVectors[])(void) = {
    ...
    LP_FLEXCOMM0_IRQHandler,        // 51 : LP_FLEXCOMM0 (LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit
                                    // interrupt)
    LP_FLEXCOMM1_IRQHandler,        // 52 : LP_FLEXCOMM1 (LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit
                                    // interrupt)
    LP_FLEXCOMM2_IRQHandler,        // 53 : LP_FLEXCOMM2 (LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit
                                    // interrupt)
    LP_FLEXCOMM3_IRQHandler,        // 54 : LP_FLEXCOMM3 (LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit
                                    // interrupt)
    LP_FLEXCOMM4_IRQHandler,        // 55 : LP_FLEXCOMM4 (LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit
                                    // interrupt)
    LP_FLEXCOMM5_IRQHandler,        // 56 : LP_FLEXCOMM5 (LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit
                                    // interrupt)
    LP_FLEXCOMM6_IRQHandler,        // 57 : LP_FLEXCOMM6 (LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit
                                    // interrupt)
    LP_FLEXCOMM7_IRQHandler,        // 58 : LP_FLEXCOMM7 (LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit
                                    // interrupt)
    LP_FLEXCOMM8_IRQHandler,        // 59 : LP_FLEXCOMM8 (LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit
                                    // interrupt)
    LP_FLEXCOMM9_IRQHandler,        // 60 : LP_FLEXCOMM9 (LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit
                                    // interrupt)
    ...
    SEC_VIO_IRQHandler,         // 88 : Secure violation interrupt (Memory Block Checker interrupt or secure AHB matrix
                                // violation interrupt)
