...
{
	lv_obj_add_event_cb(ui->screen_StationButton1, screen_StationButton1_event_handler, LV_EVENT_CLICKED, ui);
	lv_obj_add_event_cb(ui->screen_StationButton2, screen_StationButton2_event_handler, LV_EVENT_CLICKED, ui);
	lv_obj_add_event_cb(ui->screen_StationButton3, screen_StationButton3_event_handler, LV_EVENT_CLICKED, ui);
	lv_obj_add_event_cb(ui->screen_StationButton4, screen_StationButton4_event_handler, LV_EVENT_CLICKED, ui);
	lv_obj_add_event_cb(ui->screen_MinusButton, screen_MinusButton_event_handler, LV_EVENT_CLICKED, ui);
	lv_obj_add_event_cb(ui->screen_PlusButton, screen_PlusButton_event_handler, LV_EVENT_CLICKED, ui);
